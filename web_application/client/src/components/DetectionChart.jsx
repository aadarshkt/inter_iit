...
const DetectionChart = () => {
   ...
   return (
      <div className="flex flex-col w-2/3 items-center bg-white rounded-md pr-10 pl-5 pb-5 m-5 shadow-lg">
         ...
         <button className="bg-black text-white" onClick={resetZoom}>
            Reset Zoom{" "}
         </button>
         <button className="bg-black text-white" onClick={zoomIn}>
            Zoom In
         </button>
         <button className="bg-black text-white" onClick={zoomOut}>
            Zoom Out
         </button>
      </div>
   );
